...
class Frame(tk.Frame):
    ...
    def campos_pelicula(self):
        ...
        # Botones
        self.boton_nuevo = tk.Button(self, text="Nuevo", command = self.habiltar_campos)
    ...
    def tabla_peliculas(self):
        ...
        # Scroll para la tabla si exede 10 registros
